...
namespace Quiz.Data.Migrations
{
    ...
    [Migration("20230925151051_SeedQuotesTable")]
    partial class SeedQuotesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quiz.Models.Entities.Question", b =>
                {
                    ...
                    b.Property<int?>("AskedQuoteId")
                        .HasColumnType("int");

                    b.Property<int?>("CorrectQuoteId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AskedQuoteId");

                    b.HasIndex("CorrectQuoteId");
            ...
            modelBuilder.Entity("Quiz.Models.Entities.Question", b =>
                {
                    b.HasOne("Quiz.Models.Entities.Quote", "AskedQuote")
                        .WithMany()
                        .HasForeignKey("AskedQuoteId");

                    b.HasOne("Quiz.Models.Entities.Quote", "CorrectQuote")
                        .WithMany()
                        .HasForeignKey("CorrectQuoteId");

                    b.Navigation("AskedQuote");

                    b.Navigation("CorrectQuote");
                });
            ...
            modelBuilder.Entity("Quiz.Models.Entities.Quote", b =>
                {
                    ...
                    b.HasOne("Quiz.Models.Entities.Question", null)
                        .WithMany("Quotes")
