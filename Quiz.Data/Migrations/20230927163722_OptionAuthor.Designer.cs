...
namespace Quiz.Data.Migrations
{
    ...
    [Migration("20230927163722_OptionAuthor")]
    partial class OptionAuthor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quiz.Models.Entities.Quote", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 9,
                            AuthorId = 3,
                            Text = "A lack of transparency results in distrust and a deep sense of insecurity."
                        });
                });
            ...
            modelBuilder.Entity("Quiz.Models.Entities.Question", b =>
                {
                    ...
                    b.HasOne("Quiz.Models.Entities.Author", "OptionAuthor")
                        .WithMany()
                        .HasForeignKey("OptionAuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
